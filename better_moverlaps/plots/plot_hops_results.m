...
% Figura estilo NG-RES: average routes length
...
for l_idx = 1:length(results.lambdas)
    ...
    plot(results.n_range, results.mean_hops_sp(l_idx, :), ':', ...
        'Color', c, 'LineWidth', 1.2);

    plot(results.n_range, results.mean_hops_mo(l_idx, :), '-s', ...
        'Color', c, 'LineWidth', 1.5, ...
        'MarkerFaceColor', c, 'MarkerSize', 5);
end

xlabel('Number of flows (n)');
ylabel('Average routes length');
