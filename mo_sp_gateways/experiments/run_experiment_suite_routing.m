function results = run_experiment_suite_routing(cfg)
% Corre toda la batería de simulaciones para:
% - overlaps
% - average hops
% comparando SP vs MO
...
for l_idx = 1:num_lambdas
    ...
    fprintf('\n====================================================\n');
    fprintf('NG-RES ROUTING ONLY: lambda = %d (Lambda = %.4f, psi = %.4f)\n', lambda, Lambda, psi);
    fprintf('====================================================\n');
    ...
    for n_idx = 1:num_n
        ...
        for t = 1:cfg.num_tests
            trial = run_single_trial_routing(cfg, lambda, n, t);
